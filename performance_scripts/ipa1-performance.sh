...
python3 adc_performance_testing.py "${OUTDIR}/rearrangement/" 'https://ipa1.ireceptor.org' 'rearrangement' "${SCRIPT_DIR}/queries/rearrangements/"
...
python3 adc_performance_testing.py "${OUTDIR}/repertoire/" 'https://ipa1.ireceptor.org' 'repertoire' "${SCRIPT_DIR}/queries/repertoires/"
