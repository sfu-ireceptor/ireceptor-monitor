...
python3 adc_performance_testing.py '/home/ubuntu/ireceptor-monitor/ADC_API_Testing/OldNewResults/' 'https://airr-api2.ireceptor.org' 'rearrangement' "/home/ubuntu/ireceptor-monitor/ADC_API_Testing/JSON/"
